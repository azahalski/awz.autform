...
**version 2.1.10**    
- добавлена возможность вызвать http запрос для отправки кода.    

**version 2.1.9**    
- добавлен дополнительный параметр для разработчиков для проброса дополнительного подписанного ключем параметры формы; - добавлено правило для тестирования смс без смс шлюза.    
